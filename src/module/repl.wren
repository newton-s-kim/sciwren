...
class AnsiRepl is Repl {
  ...
  refreshLine(showCompletion) {
    ...
    if (showCompletion) {
      var completion = getCompletion()
      if (completion != null) {
        System.write("%(Color.blue)%(completion)%(Color.none)")
      }
    }
...
class Color {
  ...
  static gray { "\x1b[1;34m" }
  static pink { "\x1b[1;31m" }
  static brightWhite { "\x1b[1;37m" }
}
...
var TOKEN_COLORS = {
  Token.leftParen: Color.blue,
  Token.rightParen: Color.blue,
  Token.leftBracket: Color.blue,
  Token.rightBracket: Color.blue,
  Token.leftBrace: Color.blue,
  Token.rightBrace: Color.blue,
  Token.colon: Color.blue,
  Token.dot: Color.blue,
  Token.dotDot: Color.none,
  Token.dotDotDot: Color.none,
  Token.comma: Color.blue,
